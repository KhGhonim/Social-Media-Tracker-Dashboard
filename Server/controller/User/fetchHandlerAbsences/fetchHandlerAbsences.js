...
import { fetchHandlerAbsencesForTEQ } from "../../../config/Quries.js";

export const fetchHandlerAbsences = async (req, res) => {
  ...
  try {
    ...
    const user = await pool.query(fetchHandlerAbsencesForTEQ, [projectList]);
