...
import { fetchAllActiveAccountsForOperationsQuery } from "../../../../config/Quries.js";

export const fetchAllActiveAccountsForOperations = async (req, res) => {
    const { userID, projects } = req.query;
      ...
      try {
        ...
        const user = await pool.query(fetchAllActiveAccountsForOperationsQuery, [projectList]);
