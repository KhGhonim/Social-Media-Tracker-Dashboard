...
import { fetchHandlerAbsencesForOperationsQuery } from "../../../../config/Quries.js";

export const fetchHandlerAbsencesForOperations = async (req, res) => {
    ...
    try {
      ...
      const user = await pool.query(fetchHandlerAbsencesForOperationsQuery, [projectList]);
