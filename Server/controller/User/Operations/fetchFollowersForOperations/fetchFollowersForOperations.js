...
import { fetchFollowersForOperationsQuery } from "../../../../config/Quries.js";

export const fetchFollowersForOperations = async (req, res) => {
      ...
      try {
        ...
        const user = await pool.query(fetchFollowersForOperationsQuery, [projectList]);
